        ...
        <div class="card lg:max-w-lg bg-base-100 shadow-xl">
            <div class="card-body text-center">
                ...
                <div class="card-actions justify-center">
                    ...
                    onClick={()=>setTreatment(service)} for="booking-modal" class="btn btn-sm btn-secondary uppercase bg-gradient-to-r from-secondary to-primary">Book Appointment</label>
                </div>
            </div>
        </div>
    );
